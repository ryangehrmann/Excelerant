...
IPA → Lao script assembly. Source-script-agnostic: any pipeline that produces
IPA syllable dicts in the P/R/C/M/V/F/T shape can reuse this to assemble Lao
output, regardless of what script the source language was written in.
