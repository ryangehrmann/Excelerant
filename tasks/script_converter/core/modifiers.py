"""
core/modifiers.py
Post-parse consonant-class modifier processing for scripts that mark
consonant register/class with S/T/W-style diacritics on the way to IPA.
...
These rules apply to any pipeline whose conversion table encodes consonant
class with the ¹/²/S/T/W convention, regardless of source script/language.
"""
